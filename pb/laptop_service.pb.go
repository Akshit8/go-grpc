...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x70, 0x32, 0x8d, 0x01, 0x0a, 0x0d, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x65,
	...
	0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0c, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c, 0x61,
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *SearchLaptopRequest, opts ...grpc.CallOption) (*SearchLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/LaptopService/SearchLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LaptopService_SearchLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/LaptopService/SearchLaptop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
